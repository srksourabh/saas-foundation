...
## Authentication
- **Method**: Session-based (<auth-provider>)
...
## API security
- **Rate limiting**: Upstash/Vercel KV — 10 req/s per IP for auth, 100 req/s per user for API
...
- **Passwords**: Hashed with Argon2 (Lucia) or bcrypt (NextAuth)
